...
<div id="wrap">
       ...
       <div class="header">
        ...
        <?php } ?>onclick="mybookfunction(this.id)"onclick="mybookfunction(this.id)"
        </div>         
       ...
       <div class="center_content">
        <div class="left_content">
            ...
            <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" title="" /></span>Food & Drink</div>
        
          <div class="feat_prod_box">
            
              <div class="prod_img"><a href=""><img src="images\food.jpg" alt="" title="" border="0" /></a></div>
                
                <div class="prod_det_box">
                  <span class="special_icon"><img src="images/special_icon.gif" alt="" title="" /></span>
                  <div class="box_top"></div>
                    <div class="box_center">
                    <div class="prod_title"> Delicious Sandwich</div>
                    <p class="details">Delicious Sandwich Recipes "Sandwiches are great for an easy-going, laid back meal. If you are tired of the same old peanut butter and jelly sandwiches. then Delicious Sandwiches Recipes is the sandwich recipe Book for you!</p>
                    <a href="images\fault-in-our-stars-john-green.pdf" onclick="mybookfunction(this.id)"onclick="mybookfunction(this.id)"class="more">- Read Me -</a>
                    <div class="clear"></div>
                    </div>
          ...
          <div class="feat_prod_box">
              ...
              <div class="prod_img"><a href=""><img src="images\want-fries.jpg" alt="" title="" border="0" /></a></div>
                
                <div class="prod_det_box">
                <span class="special_icon"><img src="images/special_icon.gif" alt="" title="" /></span>
                  <div class="box_top"></div>
                    <div class="box_center">
                    <div class="prod_title">Are You Sure You Want Fries?</div>
                    <p class="details">The Bobs Burgers Book gives hungry fans their best chance to eat one of Bob Belchers beloved specialty Burgers of the Day in seventy-five original, practical recipes. With its warm, edgy humor, outstanding vocal cast, and signature musical numbers.</p>
                    <a href="Novels\like_it_happened_yesterday_singh_ravinder.pdf" onclick="mybookfunction(this.id)"class="more">- Read Me -</a>
                    <div class="clear"></div>
                    </div>
          ...
          <div class="feat_prod_box">
              ...
              <div class="prod_img"><a href=""><img src="images\kids.gif" alt="" title="" border="0" /></a></div>
                
                <div class="prod_det_box">
                  <span class="special_icon"><img src="images/special_icon.gif" alt="" title="" /></span>
                  <div class="box_top"></div>
                    <div class="box_center">
                    <div class="prod_title">Fun Recepies For Kids </div>
                    ...
                    <a href="" onclick="mybookfunction(this.id)"class="more">- Read Me -</a>
                    <div class="clear"></div>
                    </div>
          ...
          <div class="feat_prod_box">
              ...
              <div class="prod_img"><a href=""><img src="images\chicken.gif" alt="" title="" border="0" /></a></div>
                ...
                <span class="special_icon"><img src="images/special_icon.gif" alt="" title="" /></span>
                  <div class="box_top"></div>
                    ...
                    <a href="Novels\16050548497.pdf" onclick="mybookfunction(this.id)"class="more">- Read Me -</a>
                    <div class="clear"></div>
                    </div>
