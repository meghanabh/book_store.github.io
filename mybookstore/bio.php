...
<div id="wrap">
       ...
       <div class="center_content">
        <div class="left_content">
            ...
            <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" title="" /></span>Biography's</div>
        
          <div class="feat_prod_box">
            
              <div class="prod_img"><a href=""><img src="images\vivekanandad.jpg" alt="" title="" border="0" /></a></div>
                
                <div class="prod_det_box">
                  <span class="special_icon"><img src="images/special_icon.gif" alt="" title="" /></span>
                  <div class="box_top"></div>
                    <div class="box_center">
                    <div class="prod_title">Swami Vivekananda</div>
                    <p class="details">Swami Vivekananda  was an Indian Hindu monk, a chief disciple of the 19th-century Indian mystic Ramakrishna.He was a key figure in the introduction of the Indian philosophies of Vedanta and Yoga to the Western world</p>
                    <a href="" id="Novels\LifeofSVVol2.pdf" onclick="mybookfunction(this.id)" class="more">- Read Me -</a>
                    <div class="clear"></div>
                    </div>
          ...
          <div class="feat_prod_box">
              ...
              <div class="prod_img"><a href=""><img src="images\abdul.jpg" alt="" title="" border="0" /></a></div>
                
                <div class="prod_det_box">
                <span class="special_icon"><img src="images/special_icon.gif" alt="" title="" /></span>
                  <div class="box_top"></div>
                    <div class="box_center">
                    <div class="prod_title">APJ Abdul Kalam</div>
                    <p class="details">Avul Pakir Jainulabdeen Abdul Kalam better known as A. P. J. Abdul Kalam 15 October 1931 – 27 July 2015), was the 11th President of India from 2002 to 2007..</p>
                    <a href="" id="Novels\My Life_ An Illustrated Biograp - A.P.J. Abdul Kalam.pdf" onclick="mybookfunction(this.id)" class="more">- Read Me -</a>
                    <div class="clear"></div>
                    </div>
          ...
          <div class="feat_prod_box">
              ...
              <div class="prod_img"><a href=""><img src="images\modi.jpg" alt="" title="" border="0" /></a></div>
                
                <div class="prod_det_box">
                  <span class="special_icon"><img src="images/special_icon.gif" alt="" title="" /></span>
                  <div class="box_top"></div>
                    <div class="box_center">
                    <div class="prod_title">Narendra Modi</div>
                    <p class="details">Narendra Damodardas Modi (Gujarati: born 17 September 1950) is an Indian politician who is the 14th and current Prime Minister of India, in office since May 2014. He was the Chief Minister of Gujarat from 2001 to 2014, and is the Member of Parliament for Varanasi.  </p>
                    <a href="" id="Novels\modi.pdf" onclick="mybookfunction(this.id)" class="more">- Read Me -</a>
                    <div class="clear"></div>
                    </div>
          ...
          <div class="feat_prod_box">
              ...
              <div class="prod_img"><a href=""><img src="images\sachin.jpg" alt="" title="" border="0" /></a></div>
                
                <div class="prod_det_box">
                <span class="special_icon"><img src="images/special_icon.gif" alt="" title="" /></span>
                  <div class="box_top"></div>
                    <div class="box_center">
                    <div class="prod_title">Sachin Tendulkar</div>
                    ...
                    <a href="" id="Novels\sachin.pdf"  onclick="mybookfunction(this.id)" class="more">- Read Me -</a>
                    <div class="clear"></div>
                    </div>
